package controller.AdmClubeControllers;
...
public class ControllerTelaRedirectClubesAdm {
    ...
    public void irParaCriarClubes(){
        try {
            ...
            ControllerTelaCriarClubes controller = loader.getController();
    ...
    public void irParaDeletarClubes(){
        try {
            ...
            ControllerTelaDeleteClubes controller = loader.getController();
            controller.setConnection(conn);
